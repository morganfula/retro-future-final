...
const backLight = new THREE.PointLight(0x7d22ce, 10, 10);
...
const keyLight = new THREE.PointLight(0x0000ff, 5, 10);
keyLight.layers.enable(OCCLUSION_LAYER);
keyLight.position.set(2, 0, 0);
mainScene.add(keyLight);

const frontLight = new THREE.PointLight(0xffffff, 1, 10);
...
modelContainer.scale.set(7, 7, 7);
...
const fontFile = require("../font4.png");
